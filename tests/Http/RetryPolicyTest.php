...
it('uses defaults consistent with Stripe-PHP', function (): void {
...
it('disables retries with none()', function (): void {
    expect(RetryPolicy::none()->maxRetries)->toBe(0);
});

it('caps delay at maxDelay', function (): void {
...
it('applies symmetric jitter inside (1-jitter, 1+jitter) of base', function (): void {
