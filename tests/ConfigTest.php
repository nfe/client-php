...
it('routes core API to api.nfe.io', function (): void {
    $config = new Config(apiKey: 'k');
...
it('falls back to core for unknown families', function (): void {
    $config = new Config(apiKey: 'k');
