...
it('maps a spec filename to a PascalCase namespace suffix', function (): void {
...
it('handles paths and missing extensions', function (): void {
...
it('produces a safe PHP class name', function (): void {
